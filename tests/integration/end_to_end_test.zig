...
test "End-to-end: error handling and recovery" {
    ...
    try testing.expectError(@import("../../src/oci/image/manager.zig").ImageError.ImageNotFound, 
        manager.createContainerFromImage("nonexistent", "latest", "test-container", test_dir));
    ...
    try testing.expectError(@import("../../src/oci/image/manager.zig").ImageError.InvalidImage, 
        manager.createContainerFromImage("invalid-image", "latest", "test-container", test_dir));
