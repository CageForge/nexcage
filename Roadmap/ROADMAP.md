...
1. Оптимізація та рефакторинг CRI/OCI реалізації (16 годин) [feature/refactor-runtime]:
...
2. Завершення OCI-сумісного runtime (12 годин) [feature/oci-runtime-completion]:
...
3. Розширення функціональності Proxmox API клієнта (8 годин) [feature/proxmox-api-extended]:
