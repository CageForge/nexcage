...
pub const NetworkValidator = struct {
    ...
    /// Валідує налаштування інтерфейсу
    ...
    /// Валідує налаштування швидкості
